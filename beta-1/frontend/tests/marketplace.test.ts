import fs from 'fs';
import { ContractFactory, Provider, Contract, ContractIdLike, CoinQuantityLike, TestUtils, Wallet } from 'fuels';
...
describe('admin and set_admin functions', () => {
    ...
    const p = 'http://127.0.0.1:4000/graphql';

    //const PROVIDER: Provider = new Provider('https://node-beta-2.fuel.network/graphql');
    const USER: Wallet = new Wallet("0xd806c81ccecc6ba6d8daf386aa3d6ce5739c950fe78a8425d2af658f263aa7c3", PROVIDER);
    const USER2: Wallet = new Wallet("0x2aea721ffa4cd8e2317688976344cd924c041dcc34a533e2fe179a444469192e", PROVIDER);
    const WALLET: Wallet = new Wallet("0xfd20753bedcab2a4da57a32b38d4056b0dd9d78e88914ee99062c67f64994436", PROVIDER);
    const RECEIVER: Wallet = new Wallet("0x3e5a70047c5dac6437e0b6c8797946b50c34a2e520157c650543e06710197054", PROVIDER);
