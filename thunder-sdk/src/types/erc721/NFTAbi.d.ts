...
export class NFTAbi extends Contract {
  ...
  functions: {
    ...
    safeTransferFrom: InvokeFunction<
      [from: IdentityInput, to: IdentityInput, tokenId: BigNumberish],
      void
    >;

    setApprovalForAll: InvokeFunction<
      [operator: IdentityInput, approved: boolean],
      void
    >;
